      ...
      <View style={styles.container}>
        ...
        <View style={styles.footerContainer}>
          ...
          <View style={styles.googleLoginButton}>
            ...
            <View width={8} />
            <View>
              <Text style={[styles.loginText, { color: '#111A2C' }]}>
...
import CustomInput from '../../Session06/components/CustomInput';
import CustomButton from '../../Session06/components/CustomButton';
import SocialSignInButtons from '../../Session06/components/SocialSignInButtons';
type Props = {};
  ...
  return (
    <ScrollView>
      <View style={styles.root}>
        ...
        <CustomButton text="Sign In" onPress={onSubmitAsync} />
      </View>
      <View>
        <Text></Text>
