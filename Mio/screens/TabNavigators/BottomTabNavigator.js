    ...
    >
      ...
      <Tab.Screen
        ...
        options={{
          title: 'News',
          tabBarIcon: ({ focused, color, size }) => (
            <Feather name="bookmark" size={size * 0.8} color={color} />
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          title: 'Search',
          tabBarIcon: ({ focused, color, size }) => (
            <Feather name="search" size={size * 0.8} color={color} />
          ),
        }}
      />
      <Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          title: 'Favourite',
          tabBarIcon: ({ focused, color, size }) => (
            <Feather name="heart" size={size * 0.8} color={color} />
          ),
        }}
      />
      ...
      <Tab.Screen
        ...
        options={{
          title: 'Notifications',
          tabBarIcon: ({ focused, color, size }) => (
            <Feather name="bell" size={size * 0.8} color={color} />
          ),
          tabBarBadge: 9,
        }}
      />
